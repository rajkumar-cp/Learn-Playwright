...
export async function fillSignupForm(page: Page, email: string, password: string = signUpData.pass) {
    ...
    await page.locator('[data-test-id="signup-password-input"]').fill(password);
